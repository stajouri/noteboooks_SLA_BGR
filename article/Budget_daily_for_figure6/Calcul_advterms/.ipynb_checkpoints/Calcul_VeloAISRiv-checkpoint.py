...
if __name__ == '__main__':
    ...
    # --------------------
    chunk_size = {"deptht":1}
    diro = "/gpfsscratch/rech/cli/uor98hu/BILANS/1dDecomposition/RIVERS/advterms/"+term+"/"
    ...
    # ------------------------- VeloAISRiv -------------------
    # -------------------------------------------------------
    CONFCASE = "eORCA025.L75-IMHOTEP.RIVERS" 
    pathdata = "/gpfsscratch/rech/cli/uor98hu/BILANS/1dDecomposition/RIVERS/"
